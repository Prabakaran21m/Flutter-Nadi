...
class ProductionPlanvsActualScreen
    extends GetView<ProductionPlanvsActualController> {
  ProductionPlanvsActualScreen({Key? key}) : super(key: key);
            ...
            content: SizedBox(
              ...
              child: YearPicker(
                  ...
                  onChanged: (DateTime dateTime) {
                    ...
                    controller.productionplanvsactualcall();
  ...
  Widget build(BuildContext context) {
    ProductionPlanvsActualController controller =
        Get.put(ProductionPlanvsActualController());
