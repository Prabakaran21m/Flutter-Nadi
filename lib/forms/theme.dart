...
class AppTheme {
  ...
  static const Color buttonColor = Color(0xFFD6A31E);

  static const Color secondaryColor = Color(0xff84cb25);
  static const Color AppBarColor = Color(0xFF455636);
  ...
  static const Color Tabgreen = Color(0xffd5e8b7);
  ...
  static const Color bg_blue = Color(0xfff0f6ff);
  static const Color bg_pink = Color(0xfffff8f0);
  static const Color bg_green = Color(0xfffafff3);
  ...
  static const Color lableColor70 = Color(0xb3252525);
  static const Color lableColor50 = Color(0x80252525);
  static const Color lableColor80 = Color(0xCC252525);
  static const Color purple = Color(0xFF7C51FD);
  static const Color meron = Color(0xFFFF593E);
